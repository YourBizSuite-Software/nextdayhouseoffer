// app/columbus-ohio/page.js
import Script from "next/script";
import OfferForm from "../../components/OfferForm";
import HeroAddressCard from "../../components/HeroAddressCard";

export const metadata = {
  title: "Sell Your House Fast in Columbus, Ohio | Next Day House Offer",
  description:
    "We buy houses for cash in Columbus, Ohio and the surrounding metro area. Sell your Columbus house fast in any condition with no repairs, no agents, and no commissions.",
  alternates: {
    canonical: "https://nextdayhouseoffer.net/columbus-ohio",
  },
};
...
export default function ColumbusOhioPage() {
  ...
  const jsonLd = {
    ...
    "@type": "LocalBusiness",
    name: "Next Day House Offer – Columbus, Ohio",
    url: "https://nextdayhouseoffer.net/columbus-ohio",
    telephone: "+1-888-646-3983",
    email: "team@nextdayhouseoffer.net",
    logo: "https://nextdayhouseoffer.net/nextday-logo3.png",
    description:
      "Next Day House Offer buys houses as-is for cash in Columbus, Ohio and nearby cities. Sell your house fast with no repairs, no commissions, and flexible closing dates.",
    areaServed: [
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-6xl px-4 py-3 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex flex-col items-center sm:items-start gap-1">
            <img
              ...
              alt="Next Day House Offer Columbus Ohio"
      ...
      {/* ⬇️ From here down: paste EXACT same sections you already have ⬇️ */}
      {/* Just reuse everything you posted: “How do I sell my house fast”, blue band,
          benefits, states, cities, form, FAQ, footer – nothing else needs to change
          except the component name and imports above. */}

      {/* --- PASTE ALL YOUR EXISTING SECTIONS HERE UNCHANGED --- */}

      {/* I’ll keep one example so you see structure; in your file you paste all sections: */}

      {/* SECTION: HOW DO I SELL MY HOUSE FAST? – 3 big step cards */}
      {/* ... all your existing JSX exactly as in Home ... */}

      {/* and finally your footer using {year} */}
      {/* FOOTER */}
